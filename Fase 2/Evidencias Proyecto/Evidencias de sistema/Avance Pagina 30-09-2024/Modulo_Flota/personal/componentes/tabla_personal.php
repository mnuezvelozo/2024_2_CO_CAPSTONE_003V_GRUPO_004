                ...
                <td>
                    <div class="btn-group" role="group">
                        <button class="btn no-colapse" style="color: #cfbb4a" data-bs-toggle="modal" data-bs-target="#modal_actualizar"
                            onclick="completar_datos_modal_actualizar('<?= htmlspecialchars($personal['rut']) ?>', '<?= htmlspecialchars($personal['nombre']) ?>', '<?= htmlspecialchars($personal['fecha_ingreso']) ?>', '<?= htmlspecialchars($personal['id_cargo']) ?>', '<?= htmlspecialchars($personal['nombre_supervisor']) ?>')">
