...
if ($_SESSION['rol'] == 3) {
    $sql_tabla_siniestro .= " WHERE s.rut = '" . $_SESSION['rut'] . "'";
} elseif ($_SESSION['rol'] == 2) {
    $sql_tabla_siniestro .= " WHERE u.supervisor = '" . $_SESSION['rut'] . "'";
}
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>Fecha:</strong> <?= htmlspecialchars($siniestro['fecha']) ?></p>
                                            ...
                                            <p><strong>Responsable:</strong> <?= htmlspecialchars($siniestro['nombre_usuario']) ?></p>
