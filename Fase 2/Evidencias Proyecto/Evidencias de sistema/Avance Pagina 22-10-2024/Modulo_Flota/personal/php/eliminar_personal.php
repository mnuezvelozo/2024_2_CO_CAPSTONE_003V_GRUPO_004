...
try {
    ...
    if (empty($rut)) {
        throw new Exception("El RUT del usuario es obligatorio para eliminar.");
    }

    // Consulta SQL para eliminar el usuario
    $sql_eliminar = "DELETE FROM usuario WHERE rut = ?";
    ...
    if (mysqli_stmt_affected_rows($stmnt_eliminar) > 0) {
        ...
        throw new Exception("No se pudo eliminar el usuario. Verifique el RUT.");
    }
