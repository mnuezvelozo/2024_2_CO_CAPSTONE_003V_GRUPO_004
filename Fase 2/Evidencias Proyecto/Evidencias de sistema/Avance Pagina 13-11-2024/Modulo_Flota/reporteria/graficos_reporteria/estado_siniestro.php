        ...
        options: {
            ...
            scales: {
                x: {
                    ...
                    ticks: {
                        // Configura los ticks para que solo muestren números enteros
                        stepSize: 1,  // Asegura que los incrementos en el eje X sean de 1
                        callback: function(value) {
                            return value % 1 === 0 ? value : ''; // Solo muestra números enteros
                        }
                    }
                },
                y: {
