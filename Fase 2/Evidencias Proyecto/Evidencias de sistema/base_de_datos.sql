CREATE DATABASE  IF NOT EXISTS `modulo_flota` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `modulo_flota`;
...
CREATE TABLE `auditoria` (
  ...
  `patente` varchar(8) COLLATE utf8mb4_general_ci NOT NULL,
  `rut_responsable` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `fecha` date NOT NULL,
  `danos` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `documentos` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `funcionamiento` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `observaciones` text COLLATE utf8mb4_general_ci,
  `estado` enum('Pendiente','Completada') COLLATE utf8mb4_general_ci DEFAULT 'Pendiente',
...
CREATE TABLE `cargo` (
  ...
  `nombre_cargo` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `chofer_historial` (
  ...
  `patente` varchar(8) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rut_chofer` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_inicio` date DEFAULT NULL,
  `kilometraje_inicio` int DEFAULT NULL,
  `fecha_termino` date DEFAULT NULL,
  `kilometraje_termino` int DEFAULT NULL,
...
CREATE TABLE `km_historial` (
  ...
  `actualizado_por` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `patente` (`patente`),
...
CREATE TABLE `roles` (
  ...
  `nombre_rol` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`Id_Rol`)
...
CREATE TABLE `siniestro` (
  ...
  `id_tipo_siniestro` int DEFAULT NULL,
  `daño` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `solicitud_combustible` (
  ...
  `estado` enum('Pendiente','Aprobada','Denegada') COLLATE utf8mb4_general_ci DEFAULT 'Pendiente',
  `rut_autorizador` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tipo_siniestro` (
  `id_tipo_siniestro` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `usuario` (
  ...
  `clave` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_ingreso` date DEFAULT NULL,
  `fecha_termino` date DEFAULT NULL,
  `Id_Rol` int DEFAULT NULL,
  `id_cargo` int DEFAULT NULL,
  `supervisor` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `activo` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`rut`),
...
CREATE TABLE `vehiculo` (
  ...
  `rut` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `activo` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`patente`),
...
-- Dump completed on 2024-11-05 20:27:03
